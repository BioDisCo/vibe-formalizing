...
When you're happy with a given proof, add a "verified" badge in the .tex file. This is the only edit you can make. Have the badge link to the result's lean file on GitHub (base URL https://github.com/user/repo/).
